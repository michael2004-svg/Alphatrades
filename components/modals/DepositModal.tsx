      ...
      <div className="bg-[#0d1526] border border-[#1a2235] w-full max-w-md rounded-2xl overflow-hidden shadow-2xl animate-slide-up">
        ...
        <div className="px-6 py-5">
          ...
          {step === 'usdt' && (
            <div className="space-y-5">
              ...
              <div className="bg-[#070d1a] border border-warning/25 rounded-[12px] p-5 space-y-4">
                ...
                <div className="font-mono text-xs text-white break-all leading-relaxed bg-[#0a1020] rounded-[10px] p-3.5">{USDT_ADDRESS}</div>
          ...
          {step === 'card' && (
            <div className="space-y-5">
              <button onClick={() => setStep('method')} className="text-xs text-[#5A6380] hover:text-white flex items-center gap-1.5 transition-colors">← Back</button>
              <div className="bg-[#070d1a] border border-primary/20 rounded-[12px] p-10 text-center">
                <CreditCard size={34} className="text-primary mx-auto mb-4" />
                <p className="text-white font-bold">Card payments coming soon</p>
                <p className="text-[#5A6380] text-sm mt-1.5">Use M-Pesa or USDT for now</p>
              </div>
            </div>
          )}
        </div>
