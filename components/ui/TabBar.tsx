...
export default function TabBar() {
  ...
  return (
    <nav className="lg:hidden fixed bottom-0 left-0 right-0 z-[55]">
      <div className="bg-[#070d1a]/96 backdrop-blur-xl border-t border-[#1a2235] px-3 pb-safe">
        <div className="flex items-center h-[68px] gap-1.5">
          {tabs.map(({ label, href, icon: Icon, isScan }) => {
            ...
            return (
              <button
                ...
                className={`
                  flex flex-col items-center justify-center gap-1.5 py-2 px-1 rounded-xl transition-all
                  ${isScan
